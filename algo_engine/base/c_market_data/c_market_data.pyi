...
class PyDataType(enum.IntEnum):
    ...
    DTYPE_UNKNOWN: PyDataType
    DTYPE_INTERNAL: PyDataType
    DTYPE_MARKET_DATA: PyDataType
    DTYPE_TRANSACTION: PyDataType
    DTYPE_ORDER: PyDataType
    DTYPE_TICK_LITE: PyDataType
    DTYPE_TICK: PyDataType
    DTYPE_BAR: PyDataType
    DTYPE_REPORT: PyDataType
    DTYPE_INSTRUCTION: PyDataType
