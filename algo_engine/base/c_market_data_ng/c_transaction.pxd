...
cdef inline object transaction_from_header(market_data_t* market_data, bint owner):
...
cdef inline object order_from_header(market_data_t* market_data, bint owner):
