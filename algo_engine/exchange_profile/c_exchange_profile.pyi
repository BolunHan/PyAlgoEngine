...
class SessionDateStandalone(object):
    ...
    @overload
    def __sub__(self, other: timedelta) -> SessionDateStandalone: ...
    ...
    def __add__(self, other: timedelta) -> SessionDateStandalone: ...
    ...
    def fork(self) -> SessionDateStandalone:
        """Create a new SessionDateStandalone instance with the same underlying C struct (not owned), but a separate Python wrapper."""
        ...
