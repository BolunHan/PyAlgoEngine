...
cdef extern from "c_allocator_protocol.h":
    ...
    allocator_protocol* c_allocator_protocol_request(size_t size, shm_allocator_ctx* shm_allocator, heap_allocator* heap_allocator, bint with_lock) noexcept nogil
    void c_allocator_protocol_recycle(allocator_protocol* protocol, bint with_lock) noexcept nogil
